...
export const mockEventLogs: EventLog[] = [
  { id: 'e1', time: dayjs().subtract(5, 'minute').format('HH:mm:ss'), type: '预警', level: 'danger', content: '监测点DB-004沉降值32.5mm，超过阈值30mm', operator: '系统' },
  { id: 'e2', time: dayjs().subtract(15, 'minute').format('HH:mm:ss'), type: '预警', level: 'warning', content: '注浆工赵伟进入密闭舱室超过30分钟', operator: '系统' },
  { id: 'e3', time: dayjs().subtract(30, 'minute').format('HH:mm:ss'), type: '审批', level: 'info', content: '施工员张建国通过采购计划PP-2026-001', operator: '张建国' },
  { id: 'e4', time: dayjs().subtract(1, 'hour').format('HH:mm:ss'), type: '工单', level: 'warning', content: '中铁装备1号累计掘进328环，触发300环保养', operator: '系统' },
  { id: 'e5', time: dayjs().subtract(2, 'hour').format('HH:mm:ss'), type: '进度', level: 'warning', content: '围护结构施工节点延期5天完成', operator: '系统' },
  { id: 'e6', time: dayjs().subtract(3, 'hour').format('HH:mm:ss'), type: '预警', level: 'warning', content: '监测点DB-007沉降值20.3mm，接近阈值', operator: '系统' },
  { id: 'e7', time: dayjs().subtract(5, 'hour').format('HH:mm:ss'), type: '审批', level: 'info', content: '采购计划PP-2026-002已完成三级审批', operator: '陈伟' },
];
